...
_pkg_config = {
    ...
    'qt_framework':       0,
    'sip_bin':            '/usr/bin/sip',
    'sip_config_args':    '-d /usr/lib/python3.6/dist-packages -u STRIP= CFLAGS= -g -O2 -fdebug-prefix-map=/build/sip4-MT_DRN/sip4-4.19.7+dfsg=. -fstack-protector-strong -Wformat -Werror=format-security  -Wdate-time -D_FORTIFY_SOURCE=2 CFLAGS_RELEASE= CXXFLAGS= -g -O2 -fdebug-prefix-map=/build/sip4-MT_DRN/sip4-4.19.7+dfsg=. -fstack-protector-strong -Wformat -Werror=format-security  -Wdate-time -D_FORTIFY_SOURCE=2 CXXFLAGS_RELEASE= LFLAGS= -Wl,-Bsymbolic-functions -Wl,-z,relro LFLAGS_RELEASE=',
...
_default_macros = {
    ...
    'AR':                       'ar cqs',
    'CC':                       'gcc',
    'CFLAGS':                   ' -g -O2 -fdebug-prefix-map=/build/sip4-MT_DRN/sip4-4.19.7+dfsg=. -fstack-protector-strong -Wformat -Werror=format-security  -Wdate-time -D_FORTIFY_SOURCE=2',
    'CFLAGS_APP':               '',
    'CFLAGS_CONSOLE':           '',
    'CFLAGS_DEBUG':             '-g',
    ...
    'COPY':                     'cp -f',
    'CXX':                      'g++',
    'CXXFLAGS':                 ' -g -O2 -fdebug-prefix-map=/build/sip4-MT_DRN/sip4-4.19.7+dfsg=. -fstack-protector-strong -Wformat -Werror=format-security  -Wdate-time -D_FORTIFY_SOURCE=2',
    'CXXFLAGS_APP':             '',
    'CXXFLAGS_CONSOLE':         '',
    'CXXFLAGS_DEBUG':           '-g',
